...
//________________________ Player ______________
...
function movePlayer() {
    ...
    Player.x = Math.max(0, Math.min(Player.x, gameCanvas.clientWidth - Player.width))
...
function moveEnemies() {
    ...
    if (limits.minX <= 0|| limits.maxX > canvas.width - enemy.width) {
        direction *= -1
